  ...
  return (
    <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center gap-2">
            <span className={`text-xs font-mono px-1.5 py-0.5 rounded shrink-0 min-w-[88px] text-center ${
              tunnelEnabled ? "border-primary/30 bg-primary/10 text-primary" : "border-white/8 bg-white/[0.03] text-text-muted"
            }`}>Tunnel</span>
            {tunnelEnabled && !tunnelLoading && tunnelReachable ? (
              <>
                ...
                <button
                  ...
                  className="rounded p-2 text-text-muted transition-colors shrink-0 hover:bg-white/[0.05] hover:text-primary"
                >
              ...
              <>
                <div className="surface-panel-soft flex-1 flex items-center gap-2 rounded px-3 py-1.5 text-sm text-text-muted">
                  <span className="material-symbols-outlined animate-spin text-sm">progress_activity</span>
              ...
              <>
                <div className="flex-1 flex items-center gap-2 rounded border border-red-500/20 bg-red-500/10 px-3 py-1.5 text-sm text-red-600 dark:text-red-400">
          ...
          <div className="flex items-center gap-2">
            <span className={`text-xs font-mono px-1.5 py-0.5 rounded shrink-0 min-w-[88px] text-center ${
              tsEnabled ? "border-primary/30 bg-primary/10 text-primary" : "border-white/8 bg-white/[0.03] text-text-muted"
            }`}>Tailscale</span>
      ...
      <Card id="rtk">
        ...
        <div className="flex items-center justify-between gap-4 border-b border-white/8 pb-4 pt-2">
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded text-xs font-medium border transition-colors ${
                      cavemanLevel === lvl.id
                        ...
                        : "border-white/8 bg-white/[0.03] text-text-muted hover:bg-white/[0.05]"
                    }`}
                    title={lvl.desc}
                  >
                    {lvl.label}
      ...
      <Card id="require-api-key">
        ...
        {keys.length === 0 ? (
          <div className="text-center py-12">
            <div className="surface-panel-soft mb-4 inline-flex h-16 w-16 items-center justify-center rounded-full text-primary">
          ...
          <div className="flex flex-col">
            {keys.map((key) => (
              <div
                key={key.id}
                className={`group flex items-center justify-between border-b border-white/8 py-3 last:border-b-0 ${key.isActive === false ? "opacity-60" : ""}`}
              >
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <button
                      ...
                      className="rounded p-1 text-text-muted opacity-0 transition-all hover:bg-white/[0.05] hover:text-primary group-hover:opacity-100"
      ...
      >
        <div className="flex flex-col gap-4">
          <div className="surface-panel-soft rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-text-muted">
                  Expose your local DonixRouter to the internet. No port forwarding, no static IP needed. Share endpoint URL with your team or use it in Cursor, Cline, and other AI tools from anywhere.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            {TUNNEL_BENEFITS.map((benefit) => (
              <div key={benefit.title} className="surface-panel-soft flex flex-col items-center rounded-lg p-3 text-center">
          ...
          {tsInstalling && (
            <div className="flex flex-col gap-2">
              ...
              {tsInstallLog.length > 0 && (
                <div ref={tsLogRef} className="surface-code max-h-40 overflow-y-auto rounded p-2 font-mono text-xs text-text-muted">
...
function EndpointRow({ label, url, copyId, copied, onCopy, badge, actions }) {
  return (
    <div className="flex items-center gap-2">
      <span className={`text-xs font-mono px-1.5 py-0.5 rounded shrink-0 min-w-[88px] text-center border ${
          (badge === "CF" || badge === "TS") ? "border-primary/30 bg-primary/10 text-primary" : "border-white/8 bg-white/[0.03] text-text-muted"
        }`}>{label}</span>
...
function StatusAlert({ status, className = "" }) {
  ...
  return (
    <div className={`rounded border p-2 text-sm ${className} ${status.type === "success" ? "border-green-500/20 bg-green-500/10 text-green-600 dark:text-green-400" :
        status.type === "warning" ? "border-yellow-500/20 bg-yellow-500/10 text-yellow-600 dark:text-yellow-400" :
        status.type === "info" ? "border-blue-500/20 bg-blue-500/10 text-blue-600 dark:text-blue-400" :
...
function Tooltip({ text }) {
  return (
    <span className="relative group inline-flex items-center">
      ...
      <span className="pointer-events-none absolute left-5 top-1/2 z-50 w-64 -translate-y-1/2 rounded border border-white/8 bg-[rgba(10,14,22,0.96)] px-2.5 py-1.5 text-xs text-white opacity-0 shadow-lg transition-opacity group-hover:opacity-100">
        {text}
      </span>
    </span>
  );
...
function SecurityWarning({ message, action }) {
  return (
    <div className="flex items-center gap-2 rounded-lg border border-amber-500/20 bg-amber-500/10 px-3 py-2 text-amber-700 dark:text-amber-400">
