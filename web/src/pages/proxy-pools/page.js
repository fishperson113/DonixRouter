    ...
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-4 px-1 sm:gap-6 sm:px-0">
      ...
      <Card>
        ...
        {(selectedIds.length > 0 || healthChecking) && (
          <div className="mb-4 flex flex-wrap items-center gap-2 rounded-lg border border-primary/30 bg-primary/10 px-3 py-2">
              ...
              <div key={pool.id} className="flex flex-col gap-3 py-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex items-center justify-end gap-1">
                  ...
                  <button
                    ...
                    className="rounded p-2 text-text-muted hover:bg-white/[0.05] hover:text-primary"
                    title="Test proxy"
        ...
        <div className="flex flex-col gap-4">
          <div>
            ...
            <textarea
              ...
              className="custom-scrollbar w-full min-h-[180px] rounded-[14px] border border-white/45 bg-white/74 px-3 py-2 text-sm text-text-main shadow-[inset_0_1px_0_rgba(255,255,255,0.82)] transition-all focus:border-primary/50 focus:outline-none focus:ring-1 focus:ring-primary/30 dark:border-white/8 dark:bg-[rgba(255,255,255,0.035)] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]"
            />
      ...
      >
        <div className="flex flex-col gap-4">
          <div className="surface-panel-soft flex flex-col gap-1.5 rounded-lg border-blue-500/20 p-3">
      ...
      >
        <div className="flex flex-col gap-4">
          ...
          <div className="surface-panel-soft flex flex-col gap-3 rounded-lg p-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
