    ...
    <Card>
      ...
      <div className="flex flex-col gap-2.5">
        ...
        <Row label="Model">
          {isCustom ? (
            <input
              ...
              className="w-full px-3 py-1.5 text-sm border border-white/45 dark:border-white/8 rounded-lg bg-white/74 dark:bg-[rgba(255,255,255,0.035)] shadow-[inset_0_1px_0_rgba(255,255,255,0.82)] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] focus:outline-none focus:border-primary font-mono"
            />
          ) : (
            <select
              value={selectedModel}
              onChange={(e) => setSelectedModel(e.target.value)}
              className="w-full px-3 py-1.5 text-sm border border-white/45 dark:border-white/8 rounded-lg bg-white/74 dark:bg-[rgba(255,255,255,0.035)] shadow-[inset_0_1px_0_rgba(255,255,255,0.82)] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] focus:outline-none focus:border-primary"
            >
        ...
        <Row label="Endpoint">
          <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:items-center">
            <input
              ...
              className="w-full min-w-0 flex-1 px-3 py-1.5 text-sm border border-white/45 dark:border-white/8 rounded-lg bg-white/74 dark:bg-[rgba(255,255,255,0.035)] shadow-[inset_0_1px_0_rgba(255,255,255,0.82)] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] focus:outline-none focus:border-primary font-mono"
            ...
            {tunnelEndpoint && (
              <button
                ...
                className={`flex items-center gap-1 text-xs px-2 py-1.5 rounded-lg border shrink-0 transition-colors ${
                  useTunnel ? "border-primary/40 bg-primary/10 text-primary" : "border-white/8 bg-white/[0.03] text-text-muted hover:border-primary/35 hover:bg-white/[0.05] hover:text-primary"
                }`}
              >
        ...
        <Row label="Input">
          <div className="relative">
            <input
              ...
              className="w-full px-3 py-1.5 pr-7 text-sm border border-white/45 dark:border-white/8 rounded-lg bg-white/74 dark:bg-[rgba(255,255,255,0.035)] shadow-[inset_0_1px_0_rgba(255,255,255,0.82)] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] focus:outline-none focus:border-primary"
            />
            {input && (
              <button
                type="button"
        ...
        <div className="mt-1">
          ...
          <pre className="bg-white/[0.03] border border-white/8 rounded-lg px-3 py-2.5 text-xs font-mono text-text-main overflow-x-auto whitespace-pre-wrap break-all">{curlSnippet}</pre>
        </div>
        ...
        <div>
          ...
          <pre className="bg-white/[0.03] border border-white/8 rounded-lg px-3 py-2.5 text-xs font-mono text-text-main overflow-x-auto whitespace-pre-wrap break-all opacity-70">
    ...
    <>
      <Card>
        ...
        <div className="flex flex-col gap-2.5">
          ...
          <Row label="Endpoint">
            <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:items-center">
              <span className="w-full min-w-0 flex-1 px-3 py-1.5 text-sm font-mono text-text-main bg-white/[0.03] border border-white/8 rounded-lg truncate">
          ...
          <Row label="API Key">
            <span className="px-3 py-1.5 text-sm font-mono text-text-main bg-white/[0.03] border border-white/8 rounded-lg truncate block">
          ...
          {config.hasBrowseButton && (
            <Row label="Language">
              <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:items-center">
                <button
                  onClick={openModal}
                  className="w-full min-w-0 flex-1 rounded-lg border border-white/8 bg-white/[0.03] px-3 py-1.5 text-left text-sm font-mono text-text-main shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] transition-colors hover:border-primary/40 hover:bg-white/[0.05]"
                >
                  {selectedLang
                ...
                <button
                  onClick={openModal}
                  className="flex w-full items-center justify-center gap-1 text-xs px-2.5 py-1.5 rounded-lg border border-white/8 bg-white/[0.03] text-text-muted hover:text-primary hover:border-primary/40 transition-colors sm:w-auto sm:shrink-0"
                >
                  ...
                  <button
                    ...
                    className={`px-2.5 py-1 rounded-full text-xs border transition-colors ${
                      selectedVoice === v.id
                        ...
                        : "border-white/8 bg-white/[0.03] text-text-muted hover:border-primary/40 hover:bg-white/[0.05] hover:text-primary"
                    }`}
                  >
              ...
              <div className="flex flex-col gap-1">
                <div className="relative">
                  <input
                    ...
                    className="w-full px-3 py-1.5 pr-7 text-sm border border-white/45 dark:border-white/8 rounded-lg bg-white/74 dark:bg-[rgba(255,255,255,0.035)] shadow-[inset_0_1px_0_rgba(255,255,255,0.82)] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] focus:outline-none focus:border-primary font-mono"
                  />
                  {voiceId && (
                    <button
                      type="button"
          ...
          {audioUrl ? (
            <div>
              ...
              {jsonResponse && (
                <div className="mt-3">
                  ...
                  <pre className="bg-white/[0.03] border border-white/8 rounded-lg px-3 py-2.5 text-xs font-mono text-text-main overflow-x-auto whitespace-pre-wrap break-all">
                    {JSON.stringify({
            ...
            <pre className="mt-1.5 bg-white/[0.03] border border-white/8 rounded-lg px-3 py-2.5 text-xs font-mono text-text-main overflow-x-auto whitespace-pre-wrap break-all opacity-50">{DEFAULT_TTS_RESPONSE_EXAMPLE}</pre>
          </div>
          )}
        </div>
      </Card>
      ...
      {modalOpen && (
        ...
        >
          <div
            className="surface-panel rounded-xl shadow-2xl w-full max-w-md mx-4 flex flex-col max-h-[80vh]"
            style={{ backgroundColor: "var(--color-bg)", isolation: "isolate" }}
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header */}
            <div className="flex items-center justify-between px-4 py-3 border-b border-white/8 shrink-0 rounded-t-xl">
                ...
                <div className="flex flex-col gap-0.5">
                  {filteredLanguages.map((c) => (
                    <button
                      ...
                      className={`flex items-center justify-between w-full px-3 py-2 rounded-lg text-left hover:bg-white/[0.05] transition-colors ${
    ...
    <Card>
      ...
      <div className="flex flex-col gap-2.5">
            ...
            <div className="flex flex-col gap-2">
              ...
              {refImagePreviewSrc && (
                <img
                  ...
                  alt="Reference"
                  className="max-h-40 rounded-lg border border-white/8 object-contain bg-white/[0.03]"
        ...
        {(running || progress) && useStreaming && (
          <div className="surface-panel-soft flex flex-col gap-2 rounded-lg px-3 py-2 sm:flex-row sm:items-center sm:gap-3">
        ...
        {partialImage?.b64_json && !result && (
          <div>
            ...
            <img
              ...
              alt="Partial"
              className="mt-1.5 max-w-full rounded-lg border border-white/8 bg-white/[0.02] opacity-80"
            />
          </div>
        )}
          ...
          {kind === "image" && (binaryImageUrl || result?.data?.data?.[0]) && (
            <div className="mt-2">
              ...
              <img
                ...
                alt="Generated"
                className="max-w-full rounded-lg border border-white/8 bg-white/[0.02]"
              />
            </div>
          )}
        </div>
        ...
        <Row label="Audio File">
          <div className="flex flex-col gap-2">
            <input
              ...
              className="w-full text-xs text-text-muted file:mr-2 file:cursor-pointer file:rounded-lg file:border file:border-white/8 file:bg-white/[0.03] file:px-2.5 file:py-1 file:text-text-main hover:file:border-primary/35 hover:file:bg-white/[0.05]"
            />
            {audioFile && (
