...
const STORAGE_KEY = "donixrouter.cliToolEndpointPresets";
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        className="shrink-0 rounded-lg border border-white/10 bg-white/[0.04] px-2 py-1.5 text-xs text-text-main transition-colors hover:border-primary/40 hover:bg-white/[0.06] disabled:cursor-not-allowed disabled:opacity-50"
