...
import { ClaudeToolCard, CodexToolCard, DroidToolCard, OpenClawToolCard, HermesToolCard, DefaultToolCard, OpenCodeToolCard, CoworkToolCard, CopilotToolCard, ClineToolCard, KiloToolCard, GeminiCLIToolCard, MitmLinkCard } from "./components";
...
export default function CLIToolsPageClient({ machineId }) {
  ...
  const renderToolCard = (toolId, tool) => {
    ...
    switch (toolId) {
      ...
      case "gemini-cli":
        return <GeminiCLIToolCard key={toolId} {...commonProps} activeProviders={getActiveProviders()} cloudEnabled={cloudEnabled} initialStatus={toolStatuses["gemini-cli"]} />;
      default:
  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-6 px-1 sm:px-0">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-sm text-text-muted">Configure local coding tools to use your DonixRouter providers.</p>
      </div>
