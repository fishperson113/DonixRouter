...
function CallbackContent() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[radial-gradient(circle_at_top,rgba(229,106,74,0.08),transparent_28%),#0b1118]">
      <div className="text-center p-8 max-w-md">
        ...
        {(status === "success" || status === "done") && (
          <>
            <div className="surface-panel-soft mx-auto mb-4 flex size-16 items-center justify-center rounded-full">
        ...
        {status === "manual" && (
          <>
            ...
            <div className="surface-panel rounded-lg border border-white/10 p-3 text-left">
