...
export default function ProvidersPage() {
  ...
  return (
    <div className="flex min-w-0 flex-col gap-6 px-1 sm:px-0">
      {!hasAnyResult && (
        <div className="surface-empty rounded-xl border border-dashed border-white/10 py-8 text-center">
      ...
      <div className="flex flex-col gap-4">
        ...
        {compatibleProviders.length === 0 &&
        anthropicCompatibleProviders.length === 0 ? (
          <div className="surface-empty flex items-center justify-center gap-2 rounded-xl border border-dashed border-white/10 py-2 text-sm text-text-muted">
            ...
            <button
              ...
              className={`flex w-full items-center justify-center gap-1.5 rounded-lg border px-3 py-2 text-xs font-medium transition-colors sm:w-auto sm:py-1.5 ${
                testingMode === "oauth"
                  ...
                  : "border-white/8 bg-white/[0.03] text-text-muted hover:border-primary/40 hover:bg-white/[0.05] hover:text-text-main"
              }`}
      ...
      <div className="flex flex-col gap-4">
        ...
        {!isApikeySearching && !showAllApikey && hiddenApikeyCount > 0 && (
          <button
            ...
            className="flex w-full items-center justify-center gap-1.5 rounded-lg border border-dashed border-primary/40 px-3 py-2.5 text-sm font-medium text-primary transition-colors hover:border-primary hover:bg-primary/10"
          >
      ...
      {testResults && (
        ...
        >
          <div className="absolute inset-0 bg-[rgba(3,6,11,0.62)] backdrop-blur-[6px]" />
          <div
            className="surface-panel relative w-full max-w-[600px] max-h-[86vh] overflow-y-auto rounded-xl shadow-2xl sm:max-h-[80vh]"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="sticky top-0 z-10 flex items-center justify-between rounded-t-xl border-b border-white/8 bg-[rgba(10,14,22,0.94)] px-5 py-3 backdrop-blur-sm">
              <h3 className="font-semibold">Test Results</h3>
              <button
                onClick={() => setTestResults(null)}
                className="rounded-lg p-1 text-text-muted transition-colors hover:bg-white/[0.05] hover:text-text-main"
    ...
    <div className="flex min-w-0 flex-col gap-3">
      ...
      {items.map((r, i) => (
        <div
          ...
          className="surface-panel-soft flex min-w-0 flex-wrap items-center gap-2 rounded-lg px-3 py-2 text-xs sm:flex-nowrap"
        >
          <span
