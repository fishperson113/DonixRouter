...
export default function ModelAvailabilityBadge() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {expanded && (
        <div className="surface-panel absolute right-0 top-full z-50 mt-2 w-80 overflow-hidden rounded-xl border border-white/10 shadow-2xl">
          <div className="flex items-center justify-between border-b border-white/8 bg-white/[0.03] px-4 py-3">
            ...
            <button
              onClick={fetchStatus}
              className="rounded-lg p-1 text-text-muted transition-colors hover:bg-white/[0.06] hover:text-text-main"
              title="Refresh"
            >
                      ...
                      {provModels.map((m) => {
                        ...
                        return (
                          <div
                            ...
                            className="surface-panel-soft flex items-center justify-between rounded-lg px-2.5 py-1.5"
                          >
