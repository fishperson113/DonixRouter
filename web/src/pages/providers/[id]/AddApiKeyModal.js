...
export default function AddApiKeyModal({ isOpen, provider, providerName, isCompatible, isAnthropic, authType, authHint, website, proxyPools, error, onSave, onBulkDone, onClose }) {
  ...
  const credentialPlaceholder = isCookie
    ? (provider === "grok-web"
      ...
      : provider === "kiro-web"
        ? "AccessToken=...; Idp=Google; awsccc=...; kiro-visitor-id=..."
        : "eyJhbGciOi...")
    : "";
      ...
      <div className="flex flex-col gap-4">
        ...
        {mode === "bulk" && (
          <div className="flex flex-col gap-3">
            ...
            <textarea
              className="min-h-[140px] w-full resize-y rounded-lg border border-white/10 bg-white/[0.04] p-2 text-sm font-mono text-text-main shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] focus:outline-none focus:ring-1 focus:ring-primary/40"
        ...
        {isCloudflareAi && (
          <div className="surface-panel-soft rounded-lg border border-accent/20 p-4">
