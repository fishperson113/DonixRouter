      ...
      <div className="flex flex-col gap-4">
        <div>
          ...
          <div className="flex gap-2">
            <input
              ...
              placeholder="e.g. claude-opus-4-5"
                className="flex-1 rounded-lg border border-white/10 bg-white/[0.04] px-3 py-2 text-sm text-text-main shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] focus:border-primary/40 focus:outline-none focus:ring-1 focus:ring-primary/40"
              autoFocus
            />
            <Button
              variant="secondary"
          ...
          <p className="text-xs text-text-muted mt-1">
                  Sent to provider as: <code className="rounded bg-white/[0.05] px-1 font-mono">{stripAlias(modelId.trim()) || "model-id"}</code>
          </p>
        </div>
