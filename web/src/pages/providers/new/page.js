        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          {selectedProvider && (
            <Card.Section className="flex items-center gap-3">
              <div
                className="surface-panel-soft flex size-10 items-center justify-center rounded-lg border border-white/10"
              >
                <span
                ...
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-2 p-4 rounded-lg border transition-all ${
                    formData.authMethod === method.value
                      ...
                      : "border-white/10 bg-white/[0.03] hover:border-primary/50 hover:bg-white/[0.05]"
                  }`}
                >
