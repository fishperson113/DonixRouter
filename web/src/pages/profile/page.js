...
export default function ProfilePage() {
  ...
  const handleExportDatabase = async () => {
    ...
    try {
      ...
      anchor.href = url;
      anchor.download = `DonixRouter-backup-${stamp}.json`;
      ...
      <div className="flex flex-col gap-6">
        ...
        <Card>
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
            ...
            <div className="surface-panel-soft inline-flex w-full rounded-lg p-1 sm:w-auto">
              {["light", "dark", "system"].map((option) => (
                <button
                  ...
                  className={cn(
                    ...
                    theme === option
                      ? "bg-white text-text-main shadow-sm dark:bg-[linear-gradient(180deg,rgba(253,127,82,0.94),rgba(229,106,74,0.94))] dark:text-white dark:shadow-[0_10px_22px_rgba(229,106,74,0.16)]"
          ...
          <div className="flex flex-col gap-3 border-t border-white/8 pt-4">
            <div className="surface-panel-soft flex flex-col gap-2 rounded-lg p-3 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <p className="font-medium text-sm sm:text-base">Database Location</p>
                <p className="text-xs sm:text-sm text-text-muted font-mono break-all">~/.DonixRouter/db/data.sqlite</p>
              </div>
            </div>
        ...
        <Card>
          <div className="flex items-center gap-3 mb-4">
            <div className="surface-panel-soft shrink-0 rounded-lg p-2 text-primary">
          ...
          <div className="flex flex-col gap-4">
            ...
            {settings.requireLogin === true && (
              <form onSubmit={handlePasswordChange} className="flex flex-col gap-4 border-t border-white/8 pt-4">
          ...
          <div className="flex flex-col gap-4 mt-4">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div className="flex flex-col gap-2">
                ...
                <Input
                  placeholder="https://auth.example.com/application/o/DonixRouter/"
              ...
              <div className="flex flex-col gap-2">
                ...
                <Input
                  placeholder="DonixRouter-dashboard"
            ...
            <div className="surface-code rounded-lg p-3 text-xs sm:text-sm text-text-muted">
              <p className="font-medium text-text-main mb-1">Redirect URI</p>
              <code className="block break-all font-mono">{oidcRedirectUri}</code>
            </div>

            <div className="flex flex-col gap-2 border-t border-white/8 pt-2 sm:flex-row">
        ...
        <Card>
          ...
          <div className="flex flex-col gap-4">
            ...
            {settings.fallbackStrategy === "round-robin" && (
              <div className="flex items-start justify-between gap-4 border-t border-white/8 pt-2 sm:items-center">
                <div className="flex-1 min-w-0">
            ...
            {/* Combo Round Robin */}
            <div className="flex items-start justify-between gap-4 border-t border-white/8 pt-4 sm:items-center">
              <div className="flex-1 min-w-0">
            ...
            <p className="border-t border-white/8 pt-2 text-xs italic text-text-muted">
              {settings.fallbackStrategy === "round-robin"
        ...
        <Card>
          ...
          <div className="flex flex-col gap-4">
            ...
            {settings.outboundProxyEnabled === true && (
              <form onSubmit={updateOutboundProxy} className="flex flex-col gap-4 border-t border-white/8 pt-2">
                <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col items-stretch gap-2 border-t border-white/8 pt-2 sm:flex-row sm:items-center">
                  <Button
                    type="button"
                    variant="secondary"
            ...
            {proxyStatus.message && (
              <p className={`border-t border-white/8 pt-2 text-xs sm:text-sm ${proxyStatus.type === "error" ? "text-red-500" : "text-green-500"}`}>
                {proxyStatus.message}
              </p>
            )}
          </div>
