...
export default function Footer() {
  return (
    <footer className="border-t border-white/8 bg-[linear-gradient(180deg,rgba(11,16,25,0.94),rgba(8,12,18,0.98))] pt-16 pb-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Bottom */}
        <div className="flex flex-col items-center gap-4 border-t border-white/8 pt-8 md:flex-row md:justify-between">
