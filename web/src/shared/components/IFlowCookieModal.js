        ...
        {success ? (
          ...
          <>
            <div className="space-y-2">
              ...
              <div className="surface-panel-soft space-y-2 rounded-lg p-3 text-xs">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full resize-none rounded-lg border border-white/10 bg-white/[0.04] px-3 py-2 text-sm text-text-primary placeholder-text-muted shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] focus:outline-none focus:ring-2 focus:ring-primary/40"
                rows={4}
                disabled={loading}
              />
            </div>
