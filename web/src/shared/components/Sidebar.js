...
const navItems = [
  ...
  { href: "/quota-widget", label: "Quota Widget", icon: "picture_in_picture" },
      ...
      <aside className="app-shell flex min-h-full w-72 flex-col border-r border-white/45 bg-white/76 backdrop-blur-2xl dark:border-white/8 dark:bg-[rgba(12,16,24,0.8)]">
        ...
        <div className="flex flex-col gap-3 px-6 py-4">
          <Link href="/dashboard" className="flex items-center gap-3.5">
            <div className="grid size-12 shrink-0 place-items-center rounded-[14px] border border-white/45 bg-white/75 shadow-[inset_0_1px_0_rgba(255,255,255,0.88),0_12px_30px_-12px_rgba(229,106,74,0.45)] dark:border-white/8 dark:bg-white/[0.035] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_14px_34px_-12px_rgba(0,0,0,0.42)]">
              <img src="/logo.png" alt={APP_CONFIG.name} className="size-8 object-contain" />
            </div>
            <div className="flex flex-col gap-0.5">
              <h1 className="text-[17px] font-bold tracking-[-0.03em] text-text-main leading-tight">{APP_CONFIG.name}</h1>
              <span className="text-[11px] font-medium tracking-wide text-text-muted/70 uppercase">{APP_CONFIG.subtitle}</span>
            </div>
          </Link>
