...
import { DEFAULT_PLUGINS, LOCAL_STDIO_PLUGINS, buildManagedMcpServers } from "#shared/constants/coworkPlugins.js";
...
export async function GET() {
  try {
    ...
    const hasDonixRouter = !!(config?.inferenceProvider === PROVIDER && baseUrl);
