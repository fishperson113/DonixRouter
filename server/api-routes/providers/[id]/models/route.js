...
import { refreshGoogleToken, updateProviderCredentials, refreshKiroToken } from "#sse/services/tokenRefresh.js";
    ...
    if (!config) {
      ...
      if (staticModels.length > 0) {
        return NextResponse.json({
          ...
          connectionId: connection.id,
          models: staticModels,
          warning: `Using static models list for ${connection.provider}`,
        });
      }
