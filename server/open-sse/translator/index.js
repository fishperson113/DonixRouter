...
// Eagerly load all translators via dynamic import (must run AFTER registry Maps are created)
const _initPromise = Promise.all([
  ...
  import("./request/openai-to-deepseek.js"),
  ...
  import("./response/deepseek-to-openai.js"),
...
function ensureInitialized() {
  // no-op: translators loaded eagerly via dynamic import above
}
...
// Initialize all translators â€” awaits the eager dynamic imports
