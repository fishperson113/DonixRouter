 ...
 * JavaScript port of codex-proxy-dev/src/proxy/codex-sse.ts
 */
...
export function parseSSEBlock(block) {
  ...
  for (const line of block.split("\n")) {
    ...
    if (normalizedLine.startsWith("event:")) {
      ...
      // Compatible with non-standard upstream error streams: JSON pretty-printed
      // across multiple lines without repeating the data: prefix on continuation lines.
