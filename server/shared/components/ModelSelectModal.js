...
import { OAUTH_PROVIDERS, APIKEY_PROVIDERS, FREE_PROVIDERS, FREE_TIER_PROVIDERS, AI_PROVIDERS, isOpenAICompatibleProvider, isAnthropicCompatibleProvider, getProviderAlias } from "#shared/constants/providers.js";
    ...
    >
      ...
      <div className="mb-3">
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-lg border border-white/10 bg-white/[0.04] py-1.5 pl-8 pr-3 text-xs text-text-main shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] focus:border-primary/40 focus:outline-none focus:ring-1 focus:ring-primary/40"
          />
        </div>
      </div>
      ...
      <div className="max-h-[400px] overflow-y-auto space-y-3">
        ...
        {filteredCombos.length > 0 && (
          <div>
            <div className="sticky top-0 mb-1.5 flex items-center gap-1.5 bg-[rgba(12,16,24,0.92)] py-0.5 backdrop-blur-md">
                    ...
                    className={`
                      ...
                      ${isSelected
                        ...
                        : addedModelValues.includes(combo.name)
                          ...
                          : "border-white/10 bg-white/[0.04] text-text-main hover:border-primary/50 hover:bg-primary/10"
                      }
                    `}
                  >
                    {addedModelValues.includes(combo.name) && (
                ...
                return (
                  <button
                    ...
                    className={`
                      ...
                      ${isPlaceholder
                        ? "border-dashed border-white/10 bg-white/[0.04] italic text-text-muted hover:border-primary/50 hover:text-primary"
                        : isSelected
                          ? "bg-primary text-white border-primary"
