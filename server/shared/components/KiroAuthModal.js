        ...
        {!selectedMethod && (
          <div className="space-y-3">
            ...
            <button
              ...
              className="surface-panel-soft w-full rounded-lg border border-white/10 p-4 text-left transition-colors hover:bg-white/[0.05]"
            >
            ...
            <button
              ...
              className="surface-panel-soft hidden w-full rounded-lg border border-white/10 p-4 text-left transition-colors hover:bg-white/[0.05]"
            >
              <div className="flex items-start gap-3">
