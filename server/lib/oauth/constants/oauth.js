...
// Step 1: POST /v2/plugin/auth/state?platform=CLI â†’ get { state, authUrl }
...
// DeepSeek OAuth Configuration (Custom Login Flow)
export const DEEPSEEK_CONFIG = {
  loginUrl: "https://chat.deepseek.com/api/v0/users/login",
  sessionUrl: "https://chat.deepseek.com/api/v0/chat/session",
  powUrl: "https://chat.deepseek.com/api/v0/users/pow",
  chatUrl: "https://chat.deepseek.com/api/v0/chat/completions",
  userInfoUrl: "https://chat.deepseek.com/api/v0/users/current",
};
