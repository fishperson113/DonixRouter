...
const { log, err, dumpRequest, createResponseDumper } = require("./logger.cjs");
const { TARGET_HOSTS, URL_PATTERNS, MODEL_SYNONYMS, getToolForHost } = require("./config.cjs");
const { DATA_DIR, MITM_DIR } = require("./paths.cjs");
const { getCertForDomain } = require("./cert/generate");
const { getMitmAlias } = require("./dbReader.cjs");
...
const { removeAllDNSEntriesSync } = require("./dns/dnsConfig.cjs");
